  ...
  return (
    <div className="lifestyle-home">
      <Card title="Lifestyle Diseases" style={{  margin: '20px auto' }}>
        ...
        <h4>Cancer <Button type="primary" onClick={handleCancer} style={{ margin: '10px' }}>Cancer Prediction</Button></h4>
        ...
        <h4>Diabetes <Button type="primary" onClick={handleDiabetes} style={{ margin: '10px' }}>Diabetes Prediction</Button></h4>
