...
const ListAppointmentPage = () => {
  ...
  const handleChatRoom = (appointment) => {
    console.log(
      `Opening chat room for appointment with id: ${appointment._id}`
    );
  ...
  return (
    <div>
      <Typography>
        ...
        <Paragraph>
          Online consultations offer a range of advantages such as convenience,
          accessibility, and the ability to access specialists from any
          location. However, they also have some disadvantages. These can
          include lack of physical examination, potential miscommunications, and
          technological issues that could impact the quality of care.
        </Paragraph>
      </Typography>
              ...
              actions={[
                appointment.status === "pending" ? (
                  ...
                  <Button
                    key="chat"
                    type="primary"
                    onClick={() => handleChatRoom(appointment)}
                  >
                    Chat Room
                  </Button>
                ) : (
